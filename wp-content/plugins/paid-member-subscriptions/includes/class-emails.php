...
Class PMS_Emails {
    ...
    static function send_emails( $subscription_id = 0, $subscription_data = array(), $old_subscription_data = array() ) {
        ...
        if( ! empty( $old_subscription_data['status'] ) && ( $old_subscription_data['status'] == $subscription_data['status'] && $old_subscription_data['subscription_plan_id'] == $subscription_data['subscription_plan_id'] ) )
            return;
