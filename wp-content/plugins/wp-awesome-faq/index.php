...
function jeweltheme_wp_awesome_faq_admin_notice() {
    ...
    if ( ! get_user_meta($user_id, 'jeweltheme_ignore_notice') ) {
        ...
        printf(__('<h2 style="font-size: 20px; color: #5FA52A; font-weight: normal; margin-bottom: 10px; margin-top: 5px;">
                    <a href="https://goo.gl/kX2nGF" target="_blank">#1 Video WordPress Theme on Market, now only $49 !!!</a></h2>
                    <h4 style="font-size: 20px; color: #5FA52A; font-weight: normal; margin-bottom: 10px; margin-top: 5px;">
                    <a href="https://jeweltheme.com/product/wp-awesome-faq-pro/" target="_blank">Get WP Awesome FAQ PRO Today!</a></h4>
                    Check out Premium Features of <a href="https://jeweltheme.com/product/wp-awesome-faq-pro/" target="_blank">WP Awesome FAQ</a> Plugin. Compare Why this Plugin is really awesome !!! <br>
