						...
						<main id="content" class="cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
							...
							<div class="section title-section">
								<hgroup class="container">
									<!-- the_archive_title( '<h1 class="page-title white-text">', '</h1>' -->
									<h1 class="page-title white-text">Archivos: Cursos</h1>
									<p class="section_ flow-text white-text"><?php the_archive_description(); ?></p> <!-- this bit isn't showing but im okay with that -->
								</hgroup>
							</div>
